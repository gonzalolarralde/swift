...
// RUN: %target-run-simple-swift(-parse-as-library -enable-experimental-feature Embedded -disable-availability-checking -wmo %target-embedded-single-threaded-shim) | %FileCheck %s
