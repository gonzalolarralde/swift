...
// RUN: %target-embedded-link -nostdlib -lSystem %t/a.o %target-embedded-concurrency-threading-shim %target-embedded-posix-shim -o %t/a.out -L%swift_obj_root/lib/swift/embedded/%target-cpu-apple-macos -lswift_Concurrency -dead_strip -Wl,-undefined,dynamic_lookup
