...
// RUN: %target-embedded-link %target-clang-resource-dir-opt %t/a.o %t/executor.o %target-embedded-concurrency-threading-shim %target-embedded-posix-shim -o %t/a.out %swift_obj_root/lib/swift/embedded/%module-target-triple/libswift_Concurrency.a -dead_strip
